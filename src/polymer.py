...
test_polymer = np.random.randint(0, 35, (35,2))
...
check_if_intact(test_polymer, 35)
time_end_1 = time.perf_counter() - time_start_1

time_start_2 = time.perf_counter()
check_if_intact_2(test_polymer, 35)
time_end_2 = time.perf_counter() - time_start_2

time_start_3 = time.perf_counter()
check_if_intact_3(test_polymer, 35)
time_end_3 = time.perf_counter() - time_start_3
